...
entry_points={
    'console_scripts': [
        # Action exercises (this module - Exercise 1: Battery Charging)
...
entry_points={
    'console_scripts': [
        # Action exercises (this module - Exercise 2: Navigate to Goal)
...
entry_points={
    'console_scripts': [
        # Action exercises (this module - Exercise 3: Gripper Pick & Place)
