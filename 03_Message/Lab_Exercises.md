...
> 💡 **Note:** See [03_Message/Readme.md](../Readme.md) for complete setup.py with all 45 entry points.

```python
entry_points={
    'console_scripts': [
        # Custom Message exercises (this module - Exercise 1)
...
entry_points={
    'console_scripts': [
        # Custom Message exercises (this module - Exercise 2)
